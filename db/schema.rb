...
ActiveRecord::Schema.define(version: 2023_09_05_155650) do
  ...
  create_table "like_vtuber_communities", force: :cascade do |t|
  ...
  create_table "vtuber_communities", force: :cascade do |t|
    t.integer "vtuber_information_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "vtuber_informations", force: :cascade do |t|
